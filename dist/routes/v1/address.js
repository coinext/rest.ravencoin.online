    ...
    return __generator(this, function (_a) {
        try {
            ...
            addresses = addresses.map(function (address) {
                var path = process.env.RAVENCOINONLINE_BASEURL + "addr/" + RVNBOX.Address.toLegacyAddress(address);
            ...
            axios.all(addresses).then(axios.spread(function () {
                ...
                for (var i_1 = 0; i_1 < args.length; i_1++) {
                    ...
                    parsed.legacyAddress = RVNBOX.Address.toLegacyAddress(parsed.addrStr);
            ...
            path = process.env.RAVENCOINONLINE_BASEURL + "addr/" + RVNBOX.Address.toLegacyAddress(req.params.address);
            ...
            axios
                ...
                delete parsed.addrStr;
                parsed.legacyAddress = RVNBOX.Address.toLegacyAddress(req.params.address);
    ...
    return __generator(this, function (_a) {
        try {
            ...
            addresses_1 = addresses_1.map(function (address) {
                return RVNBOX.Address.toLegacyAddress(address);
            });
            final_1 = [];
            ...
            axios
                .get(process.env.RAVENCOINONLINE_BASEURL + "addrs/" + addresses_1 + "/utxo")
                .then(function (response) {
                var parsed = response.data;
            ...
            axios
                .get(process.env.RAVENCOINONLINE_BASEURL + "addr/" + RVNBOX.Address.toLegacyAddress(req.params.address) + "/utxo")
                .then(function (response) {
                var parsed = response.data;
                parsed.forEach(function (data) {
                    delete data.address;
                    data.legacyAddress = RVNBOX.Address.toLegacyAddress(req.params.address);
...
router.get("/unconfirmed/:address", config.addressRateLimit4, function (req, res, next) {
    try {
        ...
        axios
            .get(process.env.RAVENCOINONLINE_BASEURL + "addrs/" + addresses_2 + "/utxo")
            .then(function (response) {
            var parsed = response.data;
            parsed.forEach(function (data) {
                data.legacyAddress = RVNBOX.Address.toLegacyAddress(data.address);
...
router.get("/unconfirmed/:address", config.addressRateLimit4, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        try {
            ...
            axios
                .get(process.env.RAVENCOINONLINE_BASEURL + "txs/?address=" + RVNBOX.Address.toLegacyAddress(req.params.address))
                .then(function (response) {
                res.json(response.data);
            })
                .catch(function (error) {
